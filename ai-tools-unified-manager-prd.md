...
一个统一的 Coding Agents 配置管理平台，让开发者能在多个终端编程代理（Claude Code、Codex、OpenCode、Gemini CLI 等）间共享配置和查找历史会话。
...
**短期目标**：构建一个本地优先的统一管理平台，解决配置共享和会话检索两大核心问题。
...
│                                                               │
│  🔧 已安装的工具                                             │
│  ● Claude Code    ✅ 配置已应用  [查看]                      │
│  ● Codex          ⚠️  未配置      [配置]                     │
│  ● Gemini CLI     ❌ 配置失败      [修复]                    │
│                                                               │
│  📝 最近会话                                                 │
│  [1] Docker 多阶段构建 (Claude Code)  [查看]                │
│  [2] API 性能优化       (Codex)        [查看]                │
│                                                               │
│                                                               │
│  [q] 退出  [c] 配置  [s] 搜索  [?] 帮助                     │
...
**技术选型**
- TypeScript + Node.js
- TUI 框架：https://github.com/anomalyco/opentui
